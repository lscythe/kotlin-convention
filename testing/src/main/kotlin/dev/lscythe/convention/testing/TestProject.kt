...
class TestProject(
    ...
    private fun gradleRunner(vararg tasks: String): GradleRunner {
        ...
        // Try to load plugin classpath if available
        // This file is generated by java-gradle-plugin and only exists in plugin modules
        return if (hasPluginClasspath()) {
    ...
    private fun hasPluginClasspath(): Boolean {
        // Check if the plugin-under-test-metadata.properties file exists on the classpath
        return Thread.currentThread().contextClassLoader
            .getResource("plugin-under-test-metadata.properties") != null
    }
